...
module Kubernetes
  ...
  class V1beta1HTTPIngressBackend
    ...
    def self.swagger_types
      {
        ...
        :'header_rules' => :'Array<String>',
        :'host_names' => :'Array<String>',
        :'name' => :'String',
        :'rewrite_rules' => :'Array<String>',
        :'service_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'headerRules')
        if (value = attributes[:'headerRules']).is_a?(Array)
          self.header_rules = value
        end
      end
      ...
      if attributes.has_key?(:'rewriteRules')
        if (value = attributes[:'rewriteRules']).is_a?(Array)
          self.rewrite_rules = value
        end
      end
    ...
    def hash
      [backend_rules, header_rules, host_names, name, rewrite_rules, service_name, service_port].hash
    end
