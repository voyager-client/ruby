...
module Kubernetes
  ...
  class V1beta1TCPIngressRuleValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'noTLS')
        self.no_tls = attributes[:'noTLS']
      end
    ...
    def hash
      [address, alpn, backend, no_tls, node_port, port].hash
    end
