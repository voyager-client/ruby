  ...
  class VoyagerAppscodeComApi
    ...
    def get_api_group_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: VoyagerAppscodeComApi.get_api_group ..."
      end
      # resource path
      local_var_path = "/apis/voyager.appscode.com/"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VoyagerAppscodeComApi#get_api_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
